...
function setup() {
  ...
  box10 = new Box(900, 300, 70, 70);
  box11 = new Box(900, 400, 70, 70);
  box12 = new Box(900, 500, 70, 70);

  box13 = new Box(700, 100, 70, 70);
  box14 = new Box(700, 200, 70, 70);
  box15 = new Box(700, 300, 70, 70);
  box16 = new Box(700, 400, 70, 70);
  box17 = new Box(700, 500, 70, 70);
  box18 = new Box(700, 600, 70, 70);

  box19 = new Box(800, 100, 70, 70);
  box20 = new Box(800, 200, 70, 70);
  box21 = new Box(800, 300, 70, 70);
  box22 = new Box(800, 400, 70, 70);
  box23 = new Box(800, 500, 70, 70);
  box24 = new Box(800, 600, 70, 70);
  box25 = new Box(800, 700, 70, 70);
  box26 = new Box(800, 800, 70, 70);
